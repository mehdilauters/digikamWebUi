...
<?php echo $this->Form->create('ImagePosition'); ?>
	<fieldset>
		<legend><?php echo __('Edit Image Position'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ImagePosition.imageid')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ImagePosition.imageid'))); ?></li>
